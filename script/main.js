    ...
    const renderRest = (array) => {
        ...
        array.forEach((card) => {
            container.insertAdjacentHTML("beforeend", `
                <router-link to="/tanuki.html?id=${card.id}" class="products-card">
